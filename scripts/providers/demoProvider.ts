...
export class DemoProvider implements DataProvider {
  ...
  async fetchSnapshot(): Promise<ProviderSnapshot> {
    ...
    return {
      ...
      mode: 'demo',
      observations: {
        brent: observation('brent', 'Brent Crude', 96.78, 93.16, 'USD/barrel', baseline(82, 5)),
        us10y: observation('us10y', 'US 10Y Treasury', 4.72, 4.67, '%', baseline(4.18, 0.18)),
        hormuz: {
          ...observation(
            'hormuz',
        ...
        sp500: observation('sp500', 'S&P 500', 6028.41, 6158.99, 'points', baseline(6480, 140)),
      },
    }
  }
}
